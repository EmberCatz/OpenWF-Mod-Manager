    ...
    <div className="settings">
      ...
      <div className="field" style={{ marginTop: "1.5rem" }}>
        ...
        <p className="hint">
          ...
          sponsored by, or otherwise connected to Digital Extremes Ltd.</strong> WARFRAME® and the WARFRAME logo
          are registered trademarks of Digital Extremes Ltd.; they, and any other game content/assets referenced
          here, remain the property of their respective owners. Their use here is solely to describe compatibility
        ...
        <p className="hint">
          ...
          or interact with Digital Extremes' official servers in any way.
        </p>
        <p className="hint">
          ...
          project. Using modified clients or unofficial servers with Warframe may conflict with Digital Extremes'
          End User License Agreement — you're solely responsible for understanding and complying with whatever
          terms apply to your own use.
        </p>
        <p className="hint">
